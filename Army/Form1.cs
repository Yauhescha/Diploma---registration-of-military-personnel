...
namespace Army
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            upload();
            loadNames();
            dataGridView8.Columns[6].HeaderText = "Стадия оформления";
            dataGridView20.Columns[2].HeaderText = "ВУЗ";
            dataGridView12.Columns[4].HeaderText = "Когда применено";
            dataGridView17.Columns[3].HeaderText = "Когда применено";
        }
        // добавить служащего
